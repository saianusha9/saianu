...
import com.fittoch.validator.ProValidation;
...
private static final String UPLOAD_DIRECTORY ="/repro";  
	...
	public ModelAndView saveProduct(@Valid @ModelAttribute("prod")Product prod, BindingResult result,Model s,HttpServletRequest req)
	{
...
//        req.setAttribute("ïmages", src);
        ...
        proValidation.validate(prod, result);
        if(result.hasErrors())
        {
